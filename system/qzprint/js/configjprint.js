	 ...
	 monitorPrinting();
      ...
      function printZPLImage() {
         ...
         if (qz != null) {
            ...
            // qz-print to use raw image printing.  If this is not supplied, qz-print
	 ...
	 monitorPrinting();
      ...
      function printPages() {
         ...
         if (qz != null) {
            /*qz.append("A590,1600,2,3,1,1,N,\"QZ PRINT PLUGIN 1\"\n");
            qz.append("A590,1570,2,3,1,1,N,\"Testing the printPages() function\"\n");
            qz.append("P1\n");
            
            qz.append("A590,1600,2,3,1,1,N,\"QZ PRINT PLUGIN 2\"\n");
            qz.append("A590,1570,2,3,1,1,N,\"Testing the printPages() function\"\n");
            qz.append("P1\n");
            
            qz.append("A590,1600,2,3,1,1,N,\"QZ PRINT PLUGIN 3\"\n");
            qz.append("A590,1570,2,3,1,1,N,\"Testing the printPages() function\"\n");
            qz.append("P1\n");
            
            qz.append("A590,1600,2,3,1,1,N,\"QZ PRINT PLUGIN 4\"\n");
            qz.append("A590,1570,2,3,1,1,N,\"Testing the printPages() function\"\n");
            qz.append("P1\n");
            
            qz.append("A590,1600,2,3,1,1,N,\"QZ PRINT PLUGIN 5\"\n");
            qz.append("A590,1570,2,3,1,1,N,\"Testing the printPages() function\"\n");
            qz.append("P1\n");
            
            qz.append("A590,1600,2,3,1,1,N,\"QZ PRINT PLUGIN 6\"\n");
            qz.append("A590,1570,2,3,1,1,N,\"Testing the printPages() function\"\n");
            qz.append("P1\n");
            
            qz.append("A590,1600,2,3,1,1,N,\"QZ PRINT PLUGIN 7\"\n");
            qz.append("A590,1570,2,3,1,1,N,\"Testing the printPages() function\"\n");
            qz.append("P1\n");
            
            qz.append("A590,1600,2,3,1,1,N,\"QZ PRINT PLUGIN 8\"\n");
            qz.append("A590,1570,2,3,1,1,N,\"Testing the printPages() function\"\n");
            qz.append("P1\n");*/
